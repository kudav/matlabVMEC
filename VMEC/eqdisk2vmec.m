...
vmec_input.ns_array = [16 32 64 128 256 512];
vmec_input.ftol_array = [1e-30  1e-30  1e-30  1e-21 1e-21 1e-19 ];
vmec_input.niter_array = [1000  2000  4000  40000 60000 80000];
vmec_input.lasym = 1;
vmec_input.nfp =1;
